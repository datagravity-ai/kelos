...
VERSION ?= latest
IMAGE_DIRS ?= cmd/kelos-controller cmd/kelos-spawner cmd/kelos-token-refresher cmd/kelos-session-runner cmd/ghproxy cmd/kelos-webhook-server claude-code codex gemini opencode cursor
